    ...
    <footer className="bg-primary-50 border-t border-primary-100">
      <div className="container-base py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-primary-900 mb-4">ML Engineer</h3>
            <p className="text-primary-600 mb-4 max-w-md">
              Machine Learning Engineer specializing in building intelligent systems and sharing knowledge through technical writing.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-primary-900 mb-4">Navigation</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-primary-900 mb-4">Connect</h3>
